...
const remarkable = new Remarkable({html: true, linkify: false, breaks: true})
  ...
  class GolosEditor extends React.Component {
    ...
    render() {
      ...
      // const autoVoteValue = !isEdit && autoVote.value const replyParams = { author,
      // permlink, parent_author, parent_permlink, type, state, originalPost, isHtml,
      // isStory, isFeedback, jsonMetadata, autoVote: autoVoteValue, payoutType,
