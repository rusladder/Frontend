...
import { processTagsToSend, validateTags, updateFavoriteTags } from 'app/utils/tags';
...
class PostForm extends React.Component {
    ...
    _post = () => {
        ...
        const { title, options, tags, editorId } = this.state;
        let error;
        ...
        if (
            ...
            body = html = this.refs.editor.getValue();
        }
