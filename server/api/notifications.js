...
//
const notifyRestApiUrl = process.env.SDC_SERVICE_FETCH_NOTIFICATION_URL;
//
...
export default function useNotificationsApi(app) {
  ...
  router.get('/notifications/:account/count', function* () {
    ...
    //
    try {
      // const notifyRestApiUrl = `https://${process.env.SDC_SERVICE_PUSH_NOTIFICATION_URL}/api/v1`
      //
